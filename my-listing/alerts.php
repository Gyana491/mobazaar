<?php 
  // Check if the 'alert' parameter is set and its value is 'success'
  if(isset($_GET['delete']) && $_GET['delete'] === 'success') {
    // Display a success alert
    echo '
    <div class="flex items-center justify-between p-5 m-5 leading-normal text-green-600 bg-green-100 rounded-lg" role="alert">
