...
<section class="justify-center bg-white dark:bg-gray-900 p-4 max-w-screen-xl  mx-auto">
<?php echo "Search Results for ". $search_query ."</br>"; ?>
</section>
...
$sql = "SELECT * FROM `mb_listings` WHERE `name` LIKE '%$search_query%' OR `description` LIKE '%$search_query%' ORDER BY listing_id DESC ";
