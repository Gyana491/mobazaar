...
require($_SERVER['DOCUMENT_ROOT']  .'/mobazaar/require/global.php');
    ...
    if(isset($_POST['submit'])){
        // Check if email id exists in the database
        $sql = "SELECT * FROM `mb_users` WHERE email = ? AND user_password = ?";
...
<head>
  <meta charset="UTF-8">
    ...
    <meta name="google-signin-client_id" content="86024458770-6sakvd8h7e4625e4ucbqbk6lfa5opqdi.apps.googleusercontent.com">
            ...
            <div class="mt-12 flex flex-col items-center">
                ...
                <div class="w-full flex-1 mt-8">
                    ...
                    <div class="py-2" x-data="{ show: true }">
                        ...
                        <div class="relative">
                            <input id="password" name="password" placeholder="Enter Password" :type="show ? 'password' : 'text'" class="text-md block px-3 py-2 rounded-lg w-full 
                        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md
                        focus:placeholder-gray-500
                        focus:bg-white 
                        focus:border-gray-600  
                ...
                <p class="mt-2 text-center dark:text-white">Don't Have an Account </p>
                <a href="./signup.php">
